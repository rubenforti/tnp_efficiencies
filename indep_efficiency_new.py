...
def indep_efficiency(workspace, bins_pt, bins_eta, results,
...
if __name__ == '__main__':
    ...
    indep_efficiency(ws, bins_pt, bins_eta, results, verbose=-1)
