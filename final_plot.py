...
filename = "results/benchmark_iso_r628/ws_iso_indep_bmark.root"
...
res_obj = results_manager("indep", "pt", "eta", import_ws=ws)
...
for bin_key in bin_dict.keys():
    ...
    n_bin, idx_pt, idx_eta = bin_dict[bin_key]
    ...
    mc_pass, mc_fail = ws.data(f"Minv_mc_pass_{bin_key}"), ws.data(f"Minv_mc_fail_{bin_key}")
